...
polygonFC = GeoJSON.FeatureCollection(GeoJSON.Feature[GeoJSON.Feature(polygon, Dict{String,Any}())])
@fact Turf.area(polygonFC) => roughly(1232921098571.292)
polygonFC = GeoJSON.FeatureCollection(GeoJSON.Feature[GeoJSON.Feature(polygon, Dict{String,Any}()),
                                                      GeoJSON.Feature(polygon, Dict{String,Any}())])
@fact Turf.area(polygonFC) => roughly(1232921098571.292 * 2)
feature = GeoJSON.Feature(polygon, Dict{String,Any}())
