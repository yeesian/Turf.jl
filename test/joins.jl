...
point1 = GeoJSON.Feature(GeoJSON.Point(Float64[1, 1]), @compat Dict{String,Any}("population" => 500))
point2 = GeoJSON.Feature(GeoJSON.Point(Float64[1, 3]), @compat Dict{String,Any}("population" => 400))
point3 = GeoJSON.Feature(GeoJSON.Point(Float64[14, 2]), @compat Dict{String,Any}("population" => 600))
point4 = GeoJSON.Feature(GeoJSON.Point(Float64[13, 1]), @compat Dict{String,Any}("population" => 500))
point5 = GeoJSON.Feature(GeoJSON.Point(Float64[19, 7]), @compat Dict{String,Any}("population" => 200))
point6 = GeoJSON.Feature(GeoJSON.Point(Float64[100, 7]), @compat Dict{String,Any}("population" => 200))
